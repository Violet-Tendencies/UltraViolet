...
SMODS.Joker{
    ...
    loc_txt = {
        name = "Broken Clock",
        text = {
            "The first card scored on the",
            "first and last hands are retriggered #1# time(s)",
            "{C:inactive}\"Right at least twice a day!\"{}"
        }
    },
    atlas = 'MiscJokers',
    rarity = 1,
    ...
    calculate = function(self, card, context)
        if context.repetition and context.other_card == G.play.cards[1] and (G.GAME.current_round.hands_played == 0 or G.GAME.current_round.hands_left == 0) then
            return {
